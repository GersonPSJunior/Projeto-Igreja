...
public class CargoBean implements Serializable {
	...
	private Predicate[] getSearchPredicates(Root<Cargo> root) {
		...
		String nomeCargo = this.example.getNomeCargo();
		if (nomeCargo != null && !"".equals(nomeCargo)) {
			predicatesList.add(builder.like(
					builder.lower(root.<String> get("nomeCargo")),
					'%' + nomeCargo.toLowerCase() + '%'));
		}
	...
	public List<Cargo> getAll() {
		...
		CriteriaQuery<Cargo> criteria = this.entityManager.getCriteriaBuilder()
				.createQuery(Cargo.class);
	...
	public Converter getConverter() {
		...
		final CargoBean ejbProxy = this.sessionContext
				.getBusinessObject(CargoBean.class);
